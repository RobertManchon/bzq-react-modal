...
### Examples
* [Live Demo](https://)
* [Code Example](https://github.com/RobertManchon/bzq-react-modal/blob/main/src/App.js)
...
* using yarn      
  `$ yarn install bzq-react-modal`

Link to access the package [here](https://www.npmjs.com/package/bzq-react-modal)
...
After having imported the Modal component and useModal Hook, you're ready to start using Modal inside your components! 🎉
...
* Display a closing icon in the header
...
| addCloseEscape | Bool | Optional | False |                                          Allows to add the functionality of modal closure using 'Esc' key |
...
| customClassName | String | Optional | - |                                                            Allows you to customize class name of each element |
| addFooterButton | Bool | Optional | False |                                          If true, a close button will be displayed in the footer of the modal |
| spinner | Bool | Optional | False |                                Allows adding a loader which will be displayed during loading of modal |
...
* [web-vitals](https://www.npmjs.com/package/web-vitals): v1.1.2

### Dev Dependencies
* [@babel/cli](https://www.npmjs.com/package/@babel/cli): v7.16.17,
* [@babel/core](https://www.npmjs.com/package/@babel/core): v4.16.17,
* [@babel/polyfill](https://www.npmjs.com/package/@babel/polyfill): v7.12.1,
* [@babel/preset-env](https://www.npmjs.com/package/@babel/preset-env): v7.16.7,
* [@babel/preset-react](https://www.npmjs.com/package/@babel/preset-react): v7.16.7,
* [@testing-library/dom](https://www.npmjs.com/search?q=%40testing-library%2Fdom): v8.10.1,
* [babel-plugin-transform-class-properties](https://www.npmjs.com/package/babel-plugin-transform-class-properties): v6.24.1,
* [babel-plugin-transform-decorators](https://www.npmjs.com/package/babel-plugin-transform-decorators): v6.24.1,
* [babel-plugin-transform-react-constant-elements](https://www.npmjs.com/package/babel-plugin-transform-react-constant-elements): v6.23.0,
* [babel-plugin-transform-react-inline-elements](https://www.npmjs.com/package/babel-plugin-transform-react-inline-elements): v6.22.0,
* [cross-env](https://www.npmjs.com/package/cross-env): v7.8.3,
* [enzyme](https://www.npmjs.com/package/enzyme): v3.11.0

## Auteur
* [Robert MANCHON](https://github.com/RobertManchon/bzq-react-modal)   
